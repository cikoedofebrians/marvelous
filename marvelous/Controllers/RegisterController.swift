...
class RegisterController: UIViewController {
    ...
    private let signInButton = CustomButton(title: "Not a new user? Sign In.", fontSize: .med)
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            self.usernameField.topAnchor.constraint(equalTo: headerView.bottomAnchor, constant: 33),
